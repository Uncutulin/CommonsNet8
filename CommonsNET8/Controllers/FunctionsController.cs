...
namespace CommonsNET8.Controllers
{
    ...
    public class SecurityFunctionsController : CommonsController
    {
        ...
        {     
            ...
            if (!User.IsInRole("IsAdmin")) return new ForbidResult();
            ...
            return (IActionResult)View("Functions/Index");
        }
        ...
        //    if (function == null) return (IActionResult)RedirectToAction(nameof(Index));

        //    return (IActionResult)View("Functions/Routes", function);
        //}
        ...
        //    return (IActionResult)PartialView("Functions/_AddRoute", id);
        //}
        ...
        //    return (IActionResult)RedirectToAction("Routes", new { id = function.Id });
        //}
